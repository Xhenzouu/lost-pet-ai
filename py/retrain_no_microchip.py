...
print("One-time retraining WITHOUT microchipping feature...\n")
...
features = ['age_years', 'days_missing', 'near_water', 'pet_type_encoded', 'barangay_encoded']
...
print("\nRetrained and saved! Now use your main predictor script normally.")
